...
=======
                        ...
                        try:
                            response = str(self.llm.generate_response(
                                system_prompt=(
                                    ...
                                    "but your own grounding check found part of it was not backed by any "
                                    "stored fact or tool result. Tell UK honestly, in ONE or TWO natural "
                                    "sentences, which part you cannot stand behind and what you could do "
                                    "to find out (check memory, ask him, or search the web). Vary your "
                                    "wording -- never reuse a stock sentence. Do not apologise repeatedly."
                                ),
                                user_input=(
            ...
            if "output-token budget" in exc_text.lower():
                try:
                    ...
                    remaining = 0
                if remaining >= 40:  # enough for a genuinely short, still-useful reply
                    try:
