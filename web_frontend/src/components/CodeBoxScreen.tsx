      ...
      <div className="flex max-h-64 min-h-[120px] flex-col overflow-hidden rounded-xl border border-slate-800 bg-black/50">
        ...
        <div className="flex-1 overflow-y-auto p-3 font-mono text-xs leading-relaxed">
          {!result ? (
            ...
            <>
              {result.stdout && <pre className="whitespace-pre-wrap text-slate-200">{result.stdout}</pre>}
              {result.stderr && <pre className="mt-1 whitespace-pre-wrap text-red-300">{result.stderr}</pre>}
