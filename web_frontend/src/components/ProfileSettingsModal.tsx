              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                    Sign in to access the monitor.py systems dashboard, virtual CLI terminal, and deep trace inspector.
                  </p>
                </div>
                ...
                <button
                  ...
                  className="w-full py-2 px-3 rounded-lg bg-brand-600 hover:bg-brand-500 text-white text-xs font-bold flex items-center justify-center gap-1.5 shadow-md shadow-brand-600/30 transition cursor-pointer"
                >
                ...
                {/* Passphrase form */}
                <form onSubmit={handlePassphraseLogin} className="space-y-2 pt-1 border-t border-slate-200 dark:border-white/10">
                  <div className="flex gap-2">
                    ...
                    <button
                      type="submit"
                      className="px-3 py-1.5 rounded-lg bg-slate-800 dark:bg-white/10 hover:bg-slate-700 text-white text-xs font-medium cursor-pointer"
                    >
                      Sign In
                    </button>
                  </div>
